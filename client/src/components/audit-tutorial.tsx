...
const TUTORIAL_STEPS = [
  {
    ...
    description: "DJZS is the Adversarial Logic Layer for the A2A economy — the Oracle that pressure-tests agent reasoning before execution.",
    icon: Target,
    color: "#F37E20",
    highlight: null,
    tip: "This is not a validation tool. It exists to find what's wrong with your reasoning.",
  },
  {
    id: "workspace",
