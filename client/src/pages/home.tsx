          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6">
            <div className="divide-y divide-border">
              <FAQItem question="How is The System different from ChatGPT or Notion AI?">
                ...
                <p className="mt-2">Centralized AI tools:</p>
                ...
                <p className="mt-3">The System is an adversarial auditing system:</p>
                <ul className="list-disc list-inside ml-2">
                ...
                <p className="text-foreground mt-3 font-semibold">The System doesn't think for you. It audits whether you're actually thinking.</p>
              </FAQItem>
              ...
              <FAQItem question="How do AI agents use the System's API?">
                ...
                <p className="text-foreground mt-2 font-semibold">Machine-readable output. Deterministic. No hallucination-friendly prose.</p>
              </FAQItem>

              <FAQItem question="Is my thinking really private?">
                <p className="text-foreground font-semibold">Yes — by design.</p>
              ...
              <FAQItem question="Where is my data stored?">
                <p className="text-foreground font-semibold">In your browser's local database (IndexedDB) on this device.</p>
              ...
              <FAQItem question="How do I back up my data?">
                <p className="text-foreground font-semibold">Export creates a single ZIP archive containing JSON + Markdown files.</p>
                ...
                <p className="text-foreground mt-2 font-semibold">Your data is yours. You can leave anytime with a complete, readable copy.</p>
              </FAQItem>

              <FAQItem question="Can I use The System on multiple devices?">
                <p className="text-foreground font-semibold">Yes, via export and import.</p>
                ...
                <p className="mt-2">Future: optional XMTP-based E2E encrypted sync across devices (serverless, opt-in).</p>
              </FAQItem>
              ...
              <FAQItem question="Is my local data encrypted?">
                ...
                <p className="mt-2">Planned: passphrase-based vault encryption (WebCrypto AES-GCM) — set a passphrase, auto-lock timer, encrypted exports.</p>
                <p className="text-foreground mt-2 font-semibold">We tell you the truth now so you can trust us later.</p>
              </FAQItem>

              <FAQItem question="What does the System's AI see?">
                <p className="text-foreground font-semibold">Only the thesis you submit for audit.</p>
                <ul className="list-disc list-inside ml-2 mt-2">
                  <li>When you submit an audit — your thesis + audit type are sent to Venice AI over HTTPS/TLS</li>
                  <li>This is <strong className="text-foreground">not end-to-end encrypted</strong> — Venice sees the plaintext to compute the audit</li>
              ...
              <FAQItem question="How does the adversarial audit work?">
                ...
                <p className="text-foreground mt-2 font-semibold">No soothing. No "great insight." Just a structured audit verdict.</p>
              </FAQItem>
              ...
              <FAQItem question="What services does the System provide?">
                ...
                <p className="mt-3 text-foreground font-semibold">Plus Trade, Decision, and Content audit services. Each feeds the others. Your audit trail compounds.</p>
              </FAQItem>
              ...
              <FAQItem question="Who uses the System?">
                <p className="text-foreground font-semibold">Two types of clients: humans who want to be challenged, and AI agents that need logic verification.</p>
                <ul className="list-disc list-inside ml-2 mt-2">
                ...
                <p className="mt-3">The System is not for casual diary-keeping, photo memories, or people who want an AI that tells them they're brilliant.</p>
                <p className="mt-2 text-foreground font-semibold">Cognitive infrastructure for a decentralized, post-surveillance A2A economy.</p>
              </FAQItem>
            </div>
          </div>
        </section>
...
function FAQItem({ question, children }: { question: string; children: ReactNode }) {
  ...
  return (
    <div className="py-8 group border-border">
      <button
        onClick={() => setIsOpen(!isOpen)}
        className="w-full flex items-center justify-between gap-6 text-left"
        data-testid={`button-faq-${question.slice(0, 20).toLowerCase().replace(/\s+/g, '-')}`}
      >
        <h3 className="text-2xl md:text-3xl font-bold text-foreground transition-colors">{question}</h3>
        <div className="shrink-0 w-12 h-12 rounded-full flex items-center justify-center transition-all border border-border">
          <motion.div
      ...
      >
        <div className="leading-relaxed font-medium text-lg pt-6 max-w-3xl space-y-4">{children}</div>
      </motion.div>
    </div>
  );
}
