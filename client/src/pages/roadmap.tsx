...
const roadmapPhases = [
  ...
  {
    phase: "04",
    title: "Distribution & Agent SDKs",
    status: "active",
    quarter: "Q2 2026",
    items: [
      { text: "Official @djzs/sdk-ts (npm) and djzs-sdk (PyPI) — two-line integration for any agent framework", done: false },
      { text: "Framework plugins for Eliza, LangChain, and AutoGPT — DJZS as a togglable safety middleware", done: false },
      { text: "Hackathon bounty program — $500 USDC bounties for trading bots using Audit-Before-Act circuit breaker", done: false },
  ...
  },
  {
    ...
    quarter: "Q3 2026",
    items: [
      { text: "Multi-Agent Synthesis (/api/audit/founder) — analyze conversation logs between bot swarms to catch cascading logic failures", done: false },
      { text: "Historical Context Ingestion (/api/audit/treasury) — vector DB (Pinecone) to ingest DAO governance history and flag precedent violations", done: false },
      { text: "Human-in-the-Loop Webhooks — high-risk FAIL verdicts fire alerts to Telegram/Discord for multisig review", done: false },
      { text: "ERC-8004 on-chain reputation registry — immutable track record of successful logic audits", done: false },
    ],
  },
  {
    phase: "06",
    title: "Trustless Oracle & Decentralization",
    status: "upcoming",
    quarter: "Q4 2026",
    items: [
      { text: "EigenLayer AVS — transition from centralized server to decentralized node operators staking ETH to guarantee audit integrity", done: false },
      { text: "zkML (Zero-Knowledge Machine Learning) — cryptographic proofs verifying DJZS-LF taxonomy applied correctly without exposing agent strategy", done: false },
      { text: "Taxonomy Governance DAO — community of AI safety researchers propose and vote on new failure codes as models evolve", done: false },
    ],
  },
];
