          ...
          <div className="space-y-12 text-sm leading-relaxed border-l border-white/[0.05] pl-8">
            <section>
              <h2 className="text-white font-black uppercase tracking-widest mb-4 flex items-center gap-3">
                <span className="text-purple-500 font-mono text-xs">01</span> Purpose
              </h2>
              <p>
            ...
            <section>
              <h2 className="text-white font-black uppercase tracking-widest mb-4 flex items-center gap-3">
                <span className="text-purple-500 font-mono text-xs">02</span> Definitions
              </h2>
            ...
            <section>
              <h2 className="text-white font-black uppercase tracking-widest mb-4 flex items-center gap-3">
                <span className="text-purple-500 font-mono text-xs">03</span> User Responsibilities & Risk
              </h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-white font-black uppercase tracking-widest mb-4 flex items-center gap-3">
                <span className="text-purple-500 font-mono text-xs">05</span> Data & Privacy
              </h2>
              <p>
            ...
            <section>
              <h2 className="text-white font-black uppercase tracking-widest mb-4 flex items-center gap-3">
                <span className="text-purple-500 font-mono text-xs">06</span> No Professional Advice
              </h2>
              <p>
            ...
            <section>
              <h2 className="text-white font-black uppercase tracking-widest mb-4 flex items-center gap-3">
                <span className="text-purple-500 font-mono text-xs">07</span> Limitation of Liability
              </h2>
              <p>
