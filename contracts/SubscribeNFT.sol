...
contract SubscribeNFT is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public immutable maxSupply; // set to 0 for "no cap"
    ...
    constructor(
        ...
        uint256 _maxSupply // use 0 if you don't want a cap
    ...
    // Optional manual withdraw if you ever hold funds in contract
