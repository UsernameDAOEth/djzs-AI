...
const IRYS_GRAPHQL = "https://arweave.mainnet.irys.xyz/graphql";
...
type Env = {
  DJZSTrustMCP: DurableObjectNamespace;
};

export class DJZSTrustMCP extends McpAgent<Env, {}, {}> {
...
export default DJZSTrustMCP.serve("/mcp", { binding: "DJZSTrustMCP" });
